...
var (
	dataRequired string = "fields cover.image_id,id,name,genres.name,genres.id,created_at,updated_at,platforms.name,platforms.platform_logo.image_id,rating,rating_count,total_rating,total_rating_count,themes.id,themes.name;"
